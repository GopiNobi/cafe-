...
def store(request):
    ...
    return render(request, 'cafe/store.html', context)
...
def loginUser(request):
    ...
    return render(request, 'cafe/login_register.html', {'page': page})
...
def viewPhoto(request, pk):
    ...
    return render(request, 'cafe/photo.html', {'photo': photo})
